...
\begin{figure}[H]
    \centering
    \caption{Simulated chain of risk aversion}
    \includegraphics{Figures/RA.eps}
    \label{RA}
    \fnote{The most extreme observation of $\gamma/S_t$ around the 50.000 observation implies a value of $S=0.00163$, while the mean implies $S = 0.0573$}
\end{figure}
