...
% Este programa trabalha sobre os dados vindos de simvars quando estes são
% simulados fora dos dados reais, isto é, ncalc dados. Serão anualizados
...
if ann == 1
    ...
    % Torna mensal a evolução do log do
...
%% Vamos multiplicar os retornos para anualizá-los if size(lnrtsim,1) > 1
if size(lnrtsim,1) > 1
